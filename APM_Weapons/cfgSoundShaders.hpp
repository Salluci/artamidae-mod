class CfgSoundShaders
{
	class Zafir_silencerShot_SoundShader
	{
		samples[]=
		{
			...
			{
				"\A3\Sounds_F\arsenal\weapons\LongRangeRifles\DMR_01_Rahim\DMR01_silencerShot_01",
				1
			},

			{
				"\A3\Sounds_F\arsenal\weapons\LongRangeRifles\DMR_01_Rahim\DMR01_silencerShot_02",
				1
			},

			{
				"\A3\Sounds_F\arsenal\weapons\LongRangeRifles\DMR_01_Rahim\DMR01_silencerShot_03",
				1
			}
		};
		volume="db0";
	...
	class Zafir_silencerTailInterior_SoundShader
	{
		samples[]=
		{
			...
			{
				"\A3\Sounds_F\arsenal\weapons\LongRangeRifles\DMR_01_Rahim\DMR01_silencerTailInterior",
				1
			}
		};
		volume="interior";
	...
	class Zafir_silencerTailMeadows_SoundShader
	{
		samples[]=
		{
			...
			{
				"\A3\Sounds_F\arsenal\weapons\LongRangeRifles\DMR_01_Rahim\DMR01_silencerTailMeadows",
				1
			}
		};
