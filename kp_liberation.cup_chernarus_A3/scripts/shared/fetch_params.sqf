...
if (true) then {KP_liberation_ace = true; ["ACE detected. Deactivating resupply script from Liberation.", "MOD"] call KPLIB_fnc_log;} else {KP_liberation_ace = false};
...
if(isServer) then {
    ...
    GET_PARAM_BOOL(KP_liberation_tutorial, "Tutorial", 0);
