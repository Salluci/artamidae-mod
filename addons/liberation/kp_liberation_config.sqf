...
GRLIB_fob_range = 165;                                                  // Build range around the main FOB building.
...
GRLIB_defended_buildingpos_part = 0.75;                                  // Multiplier for defenders in buildings.
...
GRLIB_surrender_chance = 60;                                            // Chance that enemy infantry will surrender after heavy losses are encountered.
