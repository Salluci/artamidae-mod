...
switch (KP_liberation_preset_blufor) do {
    case  1: {call compileScript ["presets\blufor\apex.sqf"];};
    case  6: {call compileScript ["presets\blufor\rhs_usaf_wdl.sqf"];};
    case  7: {call compileScript ["presets\blufor\rhs_usaf_des.sqf"];};
    default  {call compileScript ["presets\blufor\custom.sqf"];};
};

switch (KP_liberation_preset_opfor) do {
    case  1: {call compileScript ["presets\opfor\apex.sqf"];};
    case  2: {call compileScript ["presets\opfor\rhs_afrf.sqf"];};
    case  3: {call compileScript ["presets\opfor\takistan.sqf"];};
    case  4: {call compileScript ["presets\opfor\islamic_state.sqf"];};
    case  5: {call compileScript ["presets\opfor\SLA.sqf"];};
    case  6: {call compileScript ["presets\opfor\aaf.sqf"];};
    case  7: {call compileScript ["presets\opfor\nato.sqf"];};
    case  8: {call compileScript ["presets\opfor\mayhem.sqf"];};
    default  {call compileScript ["presets\opfor\custom.sqf"];};
};

switch (KP_liberation_preset_resistance) do {
    case  1: {call compileScript ["presets\resistance\apex.sqf"];};
    case  2: {call compileScript ["presets\resistance\rhs_gref.sqf"];};
    case  3: {call compileScript ["presets\resistance\middle_eastern.sqf"];};
    case  4: {call compileScript ["presets\resistance\RACS.sqf"];};
    case  5: {call compileScript ["presets\resistance\germany.sqf"];};
    default  {call compileScript ["presets\resistance\custom.sqf"];};
};

switch (KP_liberation_preset_civilians) do {
    case  1: {call compileScript ["presets\civilians\apex.sqf"];};
    case  2: {call compileScript ["presets\civilians\middle_eastern.sqf"];};
    case  4: {call compileScript ["presets\civilians\germany.sqf"];};
    default  {call compileScript ["presets\civilians\custom.sqf"];};
};
...
GRLIB_ignore_colisions_when_building = [
    ...
    "ContainmentArea_02_green_F",
    "ContainmentArea_01_green_F"
];
...
*/
KPLIB_o_squadStd    = [opfor_squad_leader, opfor_medic, opfor_machinegunner, opfor_heavygunner, opfor_aa, opfor_marksman, opfor_grenadier, opfor_rpg];
...
KPLIB_upgradeBuildings  = KP_liberation_recycle_building + KP_liberation_heli_slot_building + KP_liberation_plane_slot_building + KP_liberation_air_vehicle_building;
