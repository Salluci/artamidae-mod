...
heavy_vehicles = [
    ...
    ["B_APM_BadgerIFV",200,75,125],                         // AMV-7 Marshall
    ["B_APM_Rooikat_up",300,175,200],                         // Rooikat
    ["I_APC_Wheeled_03_cannon_charcoal_F",200,75,125],                           // AFV-4 Gorgon
    ["I_Mayhem_FV510",300,150,150],                          // FV-720 Mora
    ["B_APM_Leopard2",400,300,200],                                  // MBT-52 Kuma
    ["I_Mayhem_Merkava",500,350,225],                                  // M2A4 Slammer UP
    ["B_T_MBT_01_arty_F",600,1250,300],
...
support_vehicles = [
    ...
    ["Land_RepairDepot_01_tan_F",250,0,0],
