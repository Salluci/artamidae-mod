...
logistic_convoy_ambush = compileScript ["scripts\server\asymmetric\convoy\logistic_convoy_ambush.sqf"];
...
// Start module loop
[] spawn compileScript ["scripts\server\asymmetric\asymmetric_loop.sqf"];
