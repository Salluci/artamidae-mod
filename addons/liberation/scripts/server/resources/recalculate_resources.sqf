...
while {true} do {
...

    {
        ...
        private _heliSlots = {(typeOf _x) in KP_liberation_heli_slot_building;} count _fob_buildings;
        private _planeSlots = {(typeOf _x) in KP_liberation_plane_slot_building;} count _fob_buildings;
        private _hasAirBuilding = {(typeOf _x) in KP_liberation_air_vehicle_building;} count _fob_buildings;
        if (_hasAirBuilding > 0) then {_hasAirBuilding = true;} else {_hasAirBuilding = false;};
        private _hasRecBuilding = {(typeOf _x) in KP_liberation_recycle_building;} count _fob_buildings;
