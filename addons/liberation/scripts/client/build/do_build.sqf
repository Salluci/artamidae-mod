...
while { true } do {
    ...
    if(buildtype == 1) then {
        ...
        if ( buildtype == 8 ) then {
            ...
            if (buildtype == 6 || buildtype == 99  || (toLower _classname) in KPLIB_storageBuildings || _classname in KP_liberation_recycle_building || _classname in KP_liberation_air_vehicle_building) then {
